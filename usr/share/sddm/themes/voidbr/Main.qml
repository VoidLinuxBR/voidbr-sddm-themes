  ...
  Pane {
    ...
    Label {
      anchors {
        ...
        top: parent.top
//      topMargin: root.height * 0.1 // Ajuste a margem conforme necessári
        topMargin: 5  
      }
  ...
  Pane {
    ...
    ColumnLayout {
      ...
      Item {
        ...
        Layout.rightMargin: root.width * 0.1 // Margem para não encostar na borda direita
  ...
  states: State {
    ...
    PropertyChanges { target: darken_wallpaper; opacity: config.darkenWallpaper }
    PropertyChanges { target: blur_wallpaper; visible: true }
  }
  ...
  transitions: Transition {
    ...
    SequentialAnimation {
      ParallelAnimation {
        NumberAnimation { target: greeter; property: "opacity"; from: 1; to: 0; duration: 150 * root.animationsEnabled }
        NumberAnimation {
          target: greeter
      ...
      ScriptAction { script: { greeter.visible = false; login_page.visible = true; vkbd_container.visible = true; } }
      NumberAnimation { target: login_page; property: "opacity"; from: 0; to: 1; duration: 50 * root.animationsEnabled }
    }
  }
